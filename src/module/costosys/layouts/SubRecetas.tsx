...
function SubRecetas() {
  ...
  const valuesTable = {
    ...
    mc: 'MC',
    productionCost: 'Costo de Produccion'
  }
  // contenido de  subRecetas
  const contenTable = [
    {
      subRecipes: 'Empanadas',
      classification: 'Nose',
      total: 231.12,
      performance: 'medio',
      cost: 45.34,
      ...
      <InheritedTable tableContent={contenTable} tableProperties={valuesTable}>
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:gap-4">
          ...
          <button
            ...
            className="w-full md:w-auto text-white px-4 py-2 rounded active:opacity-80 transition-opacity duration-200"
